...
<div id="container_single_1">
    ...
    <nav id="menu_de_categorias">
        <ul>
            ...
            <li id="<?php echo $categoria->term_id; ?>" class="cat_bt" style="color: <?php echo cat_cor($categoria->term_id)?>;">
        ...
        <h1 id="content_<?php echo $categoria->term_id; ?>" class="cat_name" style=" float: left; color: <?php echo cat_cor($categoria->term_id)?>;"><a href="<?php ?>"><?php echo $categoria->cat_name; ?></h1>
                            ...
                            <div class="post" id="post-<?php the_ID(); ?>">
                                ...
                                <a href="<?php the_permalink()?>"  class="mosaic-overlay mosaic_novidades" style="bottom:-28px; height: 70px">
                                   <div class="details">
                                       ...
                                       <p class="dt_cat_home" style="color: <?php echo cat_cor($categoria->term_id)?>;" ><?php the_time('j.m.Y') ?> / <?php echo nome_categoria($post->ID); ?></p>
